...
public class koneksi {
    private String jdbcURL="jdbc:mysql://localhost:3306/tiket";
    ...
    public void SimpanAdmin(String username, String password, String level){
        try {
            String SQL ="INSERT INTO admin (username,password,level) VALUES ('"+username+"','"+password+"','"+level+"')";
    ...
    public void UbahAdmin(String username, String password, String level){
        try {
            String SQL="UPDATE admin SET password='"+password+"', level='"+level+"' WHERE username='"+username+"'";
            Statement perintah = getKoneksi().createStatement();
            perintah.executeUpdate(SQL);
